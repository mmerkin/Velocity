...
```bash
awk -v n=2 'NR <= n {print $1"\t0\t"$2}' ../../velocity/B1_Cupido_minimus/reference/GCA_965195375.1_ilCupMini1.1_genomic.fa.fai > B1_regions.bed

parallel -j 40 --memfree 400G --retries 10 \
~/apps/atlas/build/atlas estimateErrors \
--fasta $REF \
--regions $BED \
--minDeltaLL 0.001 \
--bam {} ::: */*.bam
